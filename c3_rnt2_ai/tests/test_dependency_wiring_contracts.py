...
def test_api_routes_use_explicit_runtime_services_for_multimodal_and_sessions() -> None:
    core = (BASE_DIR / "src/c3rnt2/api_server/routes/core.py").read_text(encoding="utf-8")
    multimodal = (BASE_DIR / "src/c3rnt2/api_server/routes/multimodal.py").read_text(encoding="utf-8")
    server = (BASE_DIR / "src/c3rnt2/server.py").read_text(encoding="utf-8")
...
def test_frontend_control_client_is_generated_contract_client() -> None:
    service = (REPO_DIR / "vortex-chat/services/controlService.ts").read_text(encoding="utf-8")
    generated = (REPO_DIR / "vortex-chat/contracts.generated.ts").read_text(encoding="utf-8")
